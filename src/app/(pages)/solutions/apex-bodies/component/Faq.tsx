...
const faqData: FaqItem[] = [
  {
    question: 'How do we integrate data from multiple cooperatives?',
    answer: 'CoopProfiler provides a unified platform where all member cooperatives use the same system, ensuring consistent data collection and easy aggregation for network-wide insights.',
  },
  {
    question: 'Can we track individual cooperative performance?',
    answer: 'Yes! The network dashboard provides both aggregate views and individual cooperative performance metrics, allowing you to identify trends and target support where needed.',
  },
  {
    question: 'What kind of reports can we generate?',
    answer: 'You can generate comprehensive network reports, performance comparisons, compliance summaries, and custom reports tailored to your specific stakeholder needs.',
  },
  {
    question: 'How does this help us support member cooperatives?',
    answer: 'By identifying cooperatives that need support early through performance analytics, you can provide timely assistance and resources to strengthen your entire network.',
  },
];
