...
import partnersImage from '@/assets/images/landing_page/partners.png';
          ...
          <div className="grid md:grid-cols-2 lg:gap-12.5 md:gap-5 gap-7.5">
            ...
            >
              ...
              <p className="mb-2.5 md:w-4/5">
                Strengthen your partnerships with cooperatives. From inconsistent data sharing to standardized insights that help you verify impact and make informed partnership decisions.
              </p>
            ...
            <div
              ...
              data-aos-easing="ease-in-out"
            >
              <Image src={partnersImage} alt="Partners" className="rounded-2xl" />
              <Image
                height={170}
                width={284}
                src={element7}
