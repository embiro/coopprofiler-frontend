            ...
            <div className="lg:col-span-2">
              <div className="flex justify-center md:gap-5 gap-2.5 flex-col">
                ...
                <p className="lg:mb-12.5 md:mb-5">
                  Are your partner cooperatives using different systems or no systems at all? Is it
                  difficult to verify the actual impact of your partnerships and funding?
                </p>
                <div>
                  <Link
                    href="/contact"
              ...
              <div className="bg-white rounded-2xl p-7.5">
                <div className="grid md:grid-cols-2 gap-7.5">
                  <div className="flex flex-col gap-5">
                    ...
                    <p>
                      Partner cooperatives use different formats and systems, making it hard to get
                      comparable insights.
                    </p>
                  </div>
                  <div className="flex flex-col gap-5">
                    ...
                    <p>
                      Without proper reporting, you can't verify if your partnerships and
                      investments are achieving the intended impact.
                    </p>
                  </div>
                  <div className="flex flex-col gap-5">
                    <div className="size-12.5 bg-primary rounded-full inline-flex items-center justify-center">
                    ...
                    <p>
                      Manual data collection and compilation leads to delayed reports and missed
                      opportunities to optimize partnerships.
                    </p>
                  </div>
                  <div className="flex flex-col gap-5">
                    <div className="size-12.5 bg-primary rounded-full inline-flex items-center justify-center">
                    ...
                    <p>
                      Difficulty measuring return on investment for partnerships makes it
                      challenging to make informed funding decisions.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-7.5">
              <div className="text-center mb-7.5" data-aos="fade-up">
                ...
                <p className="md:w-3/4 mx-auto">
                  CoopProfiler standardizes data across your partner network. Access consistent,
                  verified information, measure partnership impact in real-time, and build stronger,
