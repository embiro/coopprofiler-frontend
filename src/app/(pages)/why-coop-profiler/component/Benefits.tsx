        ...
        <div className="container">
          ...
          >
            <h2 className="mb-2.5 lg:text-5.5xl md:text-4.6xl text-3.4xl">
              How Does Coop Profiler Benefit Coops?
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-7.5 mb-12.5">
            <div
            ...
            <div
              className="bg-body-bg p-7.5 rounded-2xl md:col-span-2 lg:col-span-1"
              data-aos="fade-up"
              data-aos-delay={500}
              data-aos-duration={500}
              data-aos-easing="ease-in-out"
